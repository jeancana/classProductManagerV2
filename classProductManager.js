...
class ProductManager {
    ...
    //<<< READ >>>> 
    // Creando el Metodo que lea lo contenido en el Archivo productos.json
    // Privatizamos el Metodo 
    #readProducts = () => {
        ...
        try {
            ...
            // Si el Archivo productos.json NO tiene Productos Creo y devuelvo un Array vacio
            fs.writeFileSync(this.path, JSON.stringify(this.#products, null, '\t'))
